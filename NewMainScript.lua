...
local function downloadPremadeProfiles(commit)
    ...
    local success, response = pcall(function()
        return game:HttpGet('https://api.github.com/repos/groffzach9-cloud/groffzach9-cloud/contents/profiles/premade?ref=' .. commit)
    end)
...
if not shared.VapeDeveloper then
	local _, subbed = pcall(function()
		return game:HttpGet('https://github.com/groffzach9-cloud/p
				groffzach9-cloud')
	end)

	local commit = 'main'
	local ok, res = pcall(function()
		return game:HttpGet('https://api.github.com/repos/groffzach9-cloud/groffzach9-cloud/commits/main', true)
	end)
